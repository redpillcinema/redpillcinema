...
“movie”: “Movie title”,
“year”: “Year released”,
“scene”: “Brief scene context (1-2 sentences)”,
“character”: “Character name”,
“actor”: “Actor name”,
“quoteAccuracy”: “Confirmed accurate / or correction if wrong”,
“exactQuote”: “The verified exact quote”,
“coreMeaning”: “What the quote means in the film context (2-3 sentences)”,
“deeperInterpretation”: “Symbolism, themes, or foreshadowing analysis — go deeper than surface level (2-3 sentences)”,
“wildPerspective”: “A conspiracy-level, mind-bending interpretation — what if this quote was secretly about society, power, control, psychology, or the human condition? Make it provocative, slightly controversial, and impossible to unsee once you read it (3-4 sentences)”,
“socialMedia”: “A viral-ready 1-2 sentence hot take that will make people stop scrolling”
}
...
<style>{`@keyframes scanline { 0% { transform: translateY(-100%); } 100% { transform: translateY(100vh); } } @keyframes flicker { 0%, 95%, 100% { opacity: 1; } 96% { opacity: 0.4; } 97% { opacity: 1; } 98% { opacity: 0.2; } 99% { opacity: 1; } } @keyframes glitch { 0% { transform: translate(0); } 20% { transform: translate(-3px, 1px); } 40% { transform: translate(3px, -1px); } 60% { transform: translate(-2px, 2px); } 80% { transform: translate(2px, -2px); } 100% { transform: translate(0); } } @keyframes pulse-red { 0%, 100% { box-shadow: 0 0 8px rgba(204,34,0,0.3); } 50% { box-shadow: 0 0 24px rgba(204,34,0,0.7); } } @keyframes blink { 0%, 100% { opacity: 1; } 50% { opacity: 0; } } @keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } } .glitch-text { animation: glitch 0.3s steps(1) infinite; } .scanline-overlay { position: fixed; top: 0; left: 0; right: 0; height: 4px; background: rgba(204,34,0,0.08); animation: scanline 6s linear infinite; pointer-events: none; z-index: 999; } .section-card:hover { border-color: #4a1008 !important; background: #110909 !important; }`}</style>
...
```
  ...
  <div style={{
    ...
    backgroundImage: `
      radial-gradient(ellipse at 20% 20%, rgba(120,10,0,0.08) 0%, transparent 60%),
      radial-gradient(ellipse at 80% 80%, rgba(80,0,20,0.06) 0%, transparent 60%)
    `,
  }} />
  ...
  <div style={{
    ...
    <div style={{ position: "relative" }}>
      ...
      <p style={{
        color: "#4a3030", fontSize: "12px", margin: 0,
  ...
  <div style={{ maxWidth: "700px", margin: "0 auto", padding: "40px 20px 0", position: "relative", zIndex: 1 }}>
    ...
    <div style={{
      ...
      <textarea
        ...
        rows={3}
        style={{
          width: "100%", background: "#080608",
          border: "1px solid #1a0808",
          color: "#f0e8e0", fontSize: "17px",
      ...
      <div style={{ marginTop: "12px", display: "flex", flexWrap: "wrap", gap: "6px" }}>
        {EXAMPLES.map(ex => (
          <button
            ...
            onClick={() => setQuote(ex)}
            style={{
              background: "transparent", border: "1px solid #1a0808",
              color: "#4a3030", fontSize: "10px", padding: "4px 10px",
      ...
      <button
        ...
        style={{
          ...
          background: loading || !quote.trim()
            ? "#0f0608"
            : "linear-gradient(135deg, #cc2200 0%, #8b1500 50%, #cc2200 100%)",
        ...
        onMouseOver={e => {
          if (!loading && quote.trim()) e.target.style.boxShadow = "0 0 30px rgba(204,34,0,0.5)";
        }}
        onMouseOut={e => {
          if (!loading && quote.trim()) e.target.style.boxShadow = "0 0 20px rgba(204,34,0,0.3)";
        }}
      >
    ...
    {loading && (
      <div style={{ textAlign: "center", padding: "56px 0", color: "#4a3030" }}>
        <div style={{
          width: "40px", height: "40px", border: "2px solid #1a0808",
          borderTop: "2px solid #cc2200", borderRadius: "50%",
          margin: "0 auto 20px",
        ...
        <div style={{ fontSize: "10px", letterSpacing: "2px", color: "#2a1010", marginTop: "8px" }}>
          ██████████░░░░ 71%
        </div>
      </div>
    )}
    ...
    {error && (
      <div style={{
        marginTop: "20px", background: "#0f0404",
        border: "1px solid #4a0808",
        padding: "14px 18px", color: "#cc4444",
    ...
    {result && (
      <div style={{ marginTop: "28px" }}>
        ...
        <div style={{
          ...
          <div style={{
            color: "#cc2200", fontSize: "12px", letterSpacing: "4px",
          ...
          <div style={{
            display: "flex", gap: "0", borderTop: "1px solid #1a0808",
            ...
            <div style={{ flex: 1, minWidth: "140px", paddingRight: "20px", borderRight: "1px solid #1a0808", marginRight: "20px" }}>
              <div style={{ fontSize: "9px", letterSpacing: "4px", color: "#2a1010", marginBottom: "6px" }}>CHARACTER</div>
              <div style={{ color: "#d4ccc4", fontSize: "14px" }}>{result.character}</div>
            </div>
            <div style={{ flex: 1, minWidth: "140px" }}>
              <div style={{ fontSize: "9px", letterSpacing: "4px", color: "#2a1010", marginBottom: "6px" }}>PORTRAYED BY</div>
              <div style={{ color: "#d4ccc4", fontSize: "14px" }}>{result.actor}</div>
            </div>
          </div>
        </div>
        ...
        {sections.map((s) => (
          <div
            ...
            style={{
              ...
              border: `1px solid ${activeSection === s.key ? "#3a0a08" : "#1a0808"}`,
              padding: "18px 22px",
              marginBottom: "6px",
              cursor: "pointer",
              transition: "all 0.2s",
              position: "relative",
              ...(s.key === "wildPerspective" && activeSection !== s.key ? {
                borderColor: "#2a0a08",
              } : {}),
            }}
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <span style={{
                color: activeSection === s.key ? "#cc2200" : "#2a1010",
                fontSize: "16px",
                transform: activeSection === s.key ? "rotate(180deg)" : "none",
              ...
              <div style={{
                ...
                {s.key === "quoteAccuracy" ? (
                  ...
                  <div>
                    ...
                    >
                      {copied ? "✓ TRANSMITTED" : "⧉ COPY & BROADCAST"}
                    </button>
                  </div>
                ) : (
                  <p style={{
        ...
        <button
          ...
          style={{
            ...
            border: "1px solid #1a0808", color: "#2a1010",
            padding: "14px", fontFamily: "monospace", fontSize: "10px",
